 ...
 * navbar navbar-fixed-top navbar-inverse  nav  li-dropdown open ul dropdown-menu
 * padding-left  padding-top  form-group container-fluid table table-condensed table-bordered tbody pagination pull-right
 * $("#id") $(".class name") $("li[data-syscode]")
 * JpaRepository JPASpecificationExecutor PageRequest
 ...
 *    @Lob @Basic(fetch = FetchType.LAZY) @Column(name = "content",columnDefinition = "text")
